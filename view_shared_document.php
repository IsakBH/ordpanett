...
<body>
    <div class="container" id="sharedContainer">
        ...
        <div class="options" id="shared-options">
            ...
            <p><b>Eid av: </b> <?php echo htmlspecialchars($document['username']);?></p> <img class="profile-picture" id="shared-profile-picture" src="<?php echo $profile_picture_url; ?>" width=24 height=24>
